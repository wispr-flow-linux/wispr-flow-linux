...
| [Status pill input area](wayland-status-pill-input.md) | Why the pill's transparent window blocks clicks on native Wayland, why `setShape` doesn't help, and the title-published box + compositor clip that does. |
