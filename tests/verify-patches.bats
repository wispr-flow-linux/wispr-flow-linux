...
declare -gA MARKER_SAMPLES=(
	...
	[overlayvisible]='(/*WISPR_LINUX_OVERLAY_VISIBLE*/d.tD||"linux"===process.platform)&&n.setVisibleOnAllWorkspaces(!0,{visibleOnFullScreen:!0,skipTransformProcessType:!0}),n.setFullScreenable(!1)'
)
...
@test "verify: exits 1 when the overlay-visible marker is missing" {
	local fixture
	fixture="$(write_fixture overlayvisible)"
	run "$VERIFY_SH" "$fixture"
	[[ "$status" -eq 1 ]]
	[[ "$output" == *'MISSING'* ]]
}
