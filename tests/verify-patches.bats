...
declare -gA MARKER_SAMPLES=(
	...
	[autostart]='("linux"===process.platform?(/*WISPR_LINUX_AUTOSTART*/openAtLogin=>{const _d=require("path").join(require("os").homedir(),".config","autostart"),_f=_d+"/wispr-flow.desktop";try{openAtLogin?(require("fs").mkdirSync(_d,{recursive:!0}),require("fs").writeFileSync(_f,"[Desktop Entry]")):require("fs").unlinkSync(_f)}catch(_e){}})(e.openAtLogin):void 0)'
)
